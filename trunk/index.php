...
.filter { font-family: verdana, arial, sans serif; font-size: 8pt; font-weight: normal;}
...
.highlight { font-family: verdana, arial, sans serif; font-size: 10pt; background-color: yellow; }
.smallbutton { font-family: verdana, arial, sans serif; font-size: 8pt; background-color: orange; border: 1px solid black;}
.tabletext { font-family: verdana, arial, sans serif; font-size: 9pt; font-weight: normal;}
-->
</style>
</head>
...
<br/>
<table border="0" cellspacing="0" bgcolor="#000000" style="border: 1px solid black" width="100%" cellpadding="0">
  <tr bgcolor="#FFFF66">
    <td valign="top">
    <span style='font-family:Georgia; font-size:30pt; font-weight:bold;'>&nbsp;&nbsp;AEFI CONCEPT EXTRACTION STUDY</span>
    </td>
  </tr>
  <tr>
    <td>
...
<div align="center" class='copyright'>
  &copy;2005 AEFI NLP version 0.1 / Vaccine Analytic Unit - Brighton Collaboration - National Library of Medicine / License - Public Domain<br>
